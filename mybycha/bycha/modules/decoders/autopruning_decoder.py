...
from bycha.modules.decoders import AbstractDecoder, register_decoder
...
from bycha.modules.decoders.layers.autopruning_decoder_layer import AutoPruningDecoderLayer
from bycha.modules.utils import create_time_mask


@register_decoder
class AutoPruningDecoder(AbstractDecoder):
    """
    ...
    def build(self,
        ...
        self._layers = nn.ModuleList([AutoPruningDecoderLayer(d_model=self._d_model,
                                                              nhead=self._n_head,
